...
const debug = require('debug')('cmos-security:context');
const utils = require('../../lib/utils');

const tokens = new Tokens();

const CSRF_SECRET = Symbol('cmos-security#CSRF_SECRET');
const _CSRF_SECRET = Symbol('cmos-security#_CSRF_SECRET');
const NEW_CSRF_SECRET = Symbol('cmos-security#NEW_CSRF_SECRET');
const LOG_CSRF_NOTICE = Symbol('cmos-security#LOG_CSRF_NOTICE');
const INPUT_TOKEN = Symbol('cmos-security#INPUT_TOKEN');
