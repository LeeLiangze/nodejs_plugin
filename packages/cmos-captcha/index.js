...
function verifyCaptcha (ctx) {
  ...
  let val = ctx.session.sessKeys
  ctx.session.sessKeys=""
...
function makeCaptcha() {
    ...
    img.drawCircle(rand(0, 100), rand(0, 40), rand(10 , 40), rand(0x333333, 0x666666));
    //边框
    //img.drawRect(0, 0, img.w-1, img.h-1, rand(0x333333, 0x666666));
    //img.fillRect(rand(0, 100), rand(0, 40), rand(10, 35), rand(10, 35), rand(0x333333, 0x666666));
    img.fillRect(0, 0, 100, 40, 0xffffff);
    img.drawLine(rand(0, 100), rand(0, 40), rand(0, 100), rand(0, 40), rand(0x333333, 0x666666));
    //return img;

    //画曲线
    var w=img.w/2;
    var h=img.h;
    var color = rand(0x333333, 0x666666);
    ...
    for(var i=0; i<str.length; i++){
        ...
        y = 8 + rand(-10, 10);
        img.drawChar(str[i], x, y, f, rand(0x00dd00, 0x0000ff));
        x += f.w + rand(2, 8);
    }
    return { img, str };
}
