...
const debug = require('debug')('cmos:logger');
...
class Loggers extends Map {
  ...
  /**
   * @constructor
   * @param  {Object} config - cmos app config
   * - logger
   *   - {String} env - cmos app runtime env string, detail please see `app.config.env`
   ...
   *   - {String} appLogName - cmos app file logger name
   *   - {String} coreLogName - cmos core file logger name
   *   - {String} agentLogName - cmos agent file logger name
