...
class Singleton {
  constructor(options = {}) {
    assert(options.name, '[cmos:singleton] Singleton#constructor options.name is required');
    assert(options.app, '[cmos:singleton] Singleton#constructor options.app is required');
    assert(options.create, '[cmos:singleton] Singleton#constructor options.create is required');
  ...
  init() {
    ...
    assert(!(options.client && options.clients),
      `cmos:singleton ${this.name} can not set options.client and options.clients both`);
