...
框架还提供了 [cmos-development-proxyagent] 插件来方便开发者调试。

先安装和开启插件：

```bash
$ npm i cmos-development-proxyagent --save
```
...
exports.proxyagent = {
  enable: true,
  package: 'cmos-development-proxyagent',
}
```
...
完整示例代码可以在 [cmosjs/exmaples/httpclient](https://github.com/cmosjs/examples/blob/master/httpclient) 找到。

[urllib]: https://github.com/node-modules/urllib
[HttpClient]: https://github.com/cmosjs/cmos/blob/master/lib/core/httpclient.js
[formstream]: https://github.com/node-modules/formstream
[HTTP]: https://nodejs.org/api/http.html
[HTTPS]: https://nodejs.org/api/https.html
[cmos-development-proxyagent]: https://github.com/cmosjs/cmos-development-proxyagent
