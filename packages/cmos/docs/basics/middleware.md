...
在[前面的章节](../intro/cmos-and-koa.md)中，我们介绍了 cmos 是基于 Koa 1 实现的，所以 cmos 的中间件形式和 Koa 1 的中间件形式是一样的，都是基于 generator function 的[洋葱圈模型](../intro/cmos-and-koa.md#midlleware)。每次我们编写一个中间件，就相当于在洋葱外面包了一层。
